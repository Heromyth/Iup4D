 ...
 */
module im.c.converter;

//version(IM) :

import core.stdc.config : c_long;
import im.c.image;
import im.c.core: FreeEnumMembers;
...
mixin FreeEnumMembers!imComplex2Real;
...
mixin FreeEnumMembers!imGammaFactor;
...
mixin FreeEnumMembers!imCastMode;
 ...
 * \ingroup cnvutil */
void imConvertMaptoRgb(ubyte* data, int count, int depth, int packed, c_long* palette, int palette_count);
...
int imConvertRGB2Map(int width, int height, 
              ...
              ubyte* map, c_long* palette, int* palette_count);
