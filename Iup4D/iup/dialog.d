...
public class IupDialog : IupContentControl
{
    ...
    */
    @property 
	{
		...
		public void canHideTaskBar(bool value) {
            setAttribute(IupAttributes.HideTaskBar,  value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
		}
    }
    ...
    */
    @property 
	{
		public bool canShrink() { return getAttribute(IupAttributes.Shrink) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
        public bool canResize() { return getAttribute(IupAttributes.Resize) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
        public bool canSaveUnder() { return getAttribute(IupAttributes.SaveUnder) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
        public bool hasMaxBox() { return getAttribute(IupAttributes.MaxBox) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
        public bool hasMenuBox() { return getAttribute(IupAttributes.MenuBox) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
        public bool hasMinBox() { return getAttribute(IupAttributes.MinBox) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
        public bool isFullScreen() { return getAttribute(IupAttributes.FullScreen) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
        public bool maximizeBox() { return getAttribute(IupAttributes.MaxBox) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
        public bool minimizeBox() { return getAttribute(IupAttributes.MinBox) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
		public WindowSizeMode sizeMode() { return m_sizeMode; }
    ...
    */
    @property 
	{
		public int opacity()  {  return getIntAttribute(IupAttributes.Opacity); }
        public void opacity(int value) { setIntAttribute(IupAttributes.Opacity, value);}
	}
    ...
    */
    @property 
	{
		public bool isDialogFrame() { return m_isDialogFrame; }

		public void isDialogFrame(bool value) 
		{
			m_isDialogFrame = value;
			setAttribute(IupAttributes.DialogFrame, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
		}
    ...
    */
   @property public bool isModal() { return getAttribute(IupAttributes.Modal) == FlagIdentifiers.Yes; }
   ...
   */
   @property 
   {
       public bool isTopMost() { return getAttribute(IupAttributes.TopMost) == FlagIdentifiers.Yes; }
...
version(Windows)
{
    ...
    */
    @property 
	{
        public string customFrameCaptionLimits() { return getAttribute(IupAttributes.CustomFrameCaptionLimits); }
    ...
    */
    @property 
	{
        public bool hasHelpButton() { return getAttribute(IupAttributes.HelpButton) == FlagIdentifiers.Yes; }

        public void hasHelpButton(bool value)  {
            setAttribute(IupAttributes.HelpButton, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
        }
	}
    ...
    */
    @property 
	{
        public bool isCustomFrame() { return getAttribute(IupAttributes.CustomFrame) == FlagIdentifiers.Yes; }

        public void isCustomFrame(bool value)  
        {
            setAttribute(IupAttributes.CustomFrame, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
            if(value)
            {
                //  register only once
    ...
    */
    @property 
	{
        public bool isCustomFrameEx() { return getAttribute(IupAttributes.CustomFrameEx) == FlagIdentifiers.Yes; }

        public void isCustomFrameEx(bool value)  {
            setAttribute(IupAttributes.CustomFrameEx, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
        }
	}
    ...
    */
    @property 
	{
		public bool isMdiChild() { return getAttribute(IupAttributes.MdiChild) == FlagIdentifiers.Yes; }

		public void isMdiChild(bool value) 
		{
            setAttribute(IupAttributes.MdiChild, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
		}
	}
    ...
    */
    @property 
	{
		public bool isMdiContainer() { return getAttribute(IupAttributes.MdiFrame) == FlagIdentifiers.Yes; }

		public void isMdiContainer(bool value) 
		{
            setAttribute(IupAttributes.MdiFrame, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
		}
	}
    ...
    */
    @property 
	{
		public bool isToolbox() { return m_isToolbox; }

		public void isToolbox(bool value) 
		{
			m_isToolbox = value;
			setAttribute(IupAttributes.Toolbox, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
		}
    ...
    */
    @property 
	{
		public IIupButton defaultEnter() { return m_defaultEnter; }
    ...
    */
    @property 
	{
		public iup.button.IupButton defaultEsc() { return m_defaultEsc; }
    ...
    */
    @property 
	{
		public iup.dialog.IupDialog parent() { return m_parent; }
    ...
    */
    @property 
	{
		public iup.core.IupElement startFocus() { return m_startFocus; }
    ...
    */
    @property 
	{
		public DialogResult dialogResult() { return m_dialogResult; }
		protected void dialogResult(DialogResult value) { m_dialogResult = value; }
    ...
    */
    @property 
	{
		public IupTray tray() { return m_tray; }
		protected void tray(IupTray value) { m_tray = value; }
    ...
    */
    int hide() { return iup.c.IupHide(handle); }
...
public class IupTray : IupAuxiliaryObject
{
    ...
    */
    @property 
	{
		public bool enabled() { return getAttribute(IupAttributes.Tray) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
		public string tipText() { return m_tipText; }
    ...
    version(Windows)
    {
        ...
        */
        @property 
        {
            public int tipBalloonDelay()  {  return getIntAttribute(IupAttributes.TipBalloonDelay); }
            public void tipBalloonDelay(int value) { setIntAttribute(IupAttributes.TipBalloonDelay, value);}
        }
        ...
        */
        @property 
        {
            public bool hasTipBalloon() { return getAttribute(IupAttributes.TipBalloon) == FlagIdentifiers.Yes; }

            public void hasTipBalloon(bool value)  {
                setAttribute(IupAttributes.TipBalloon, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
            }
        }
        ...
        */
        @property 
        {
            public string tipBalloonTitle() { return m_balloonTitle; }
...
public class IupDialogBase : IupControl
{
    ...
    protected int popup(int x, int y) { return iup.c.IupPopup(handle, x, y); }
...
public class IupColorDialog : IupDialogBase
{
    ...
    */
    @property 
	{
		public int alpha()  {  return getIntAttribute(IupAttributes.Alpha); }
        public void alpha(int value) { setIntAttribute(IupAttributes.Alpha, value);}
	}
    ...
    */
    @property 
	{
		public bool canShowAlpha() { return getAttribute(IupAttributes.ShowAlpha) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
		public bool canShowColorTable() { return getAttribute(IupAttributes.ShowColorTable) == FlagIdentifiers.Yes; }

		public void canShowColorTable(bool value) 
		{
            setAttribute(IupAttributes.ShowColorTable, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
		}
	}
    ...
    */
    @property 
	{
		public bool canShowHex() { return getAttribute(IupAttributes.ShowHex) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
		public bool canShowHelp() { return getAttribute(IupAttributes.ShowHelp) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
		public string colorTable()  {  return getAttribute(IupAttributes.ColorTable); }
        public void colorTable(string value) { setAttribute(IupAttributes.ColorTable, value);}
	}
    ...
    */
    @property 
	{
		public string hsiValue()  {  return getAttribute(IupAttributes.ValueHsi); }
        public void hsiValue(string value) { setAttribute(IupAttributes.ValueHsi, value);}
	}
    ...
    */
    @property 
	{
		public string hexValue()  {  return getAttribute(IupAttributes.ValueHex); }
        public void hexValue(string value) { setAttribute(IupAttributes.ValueHex, value);}
	}
    ...
    */
    @property 
	{
		public string rgbValue()  {  return getAttribute(IupAttributes.Value); }
        public void rgbValue(string value) { setAttribute(IupAttributes.Value, value);}
	}
...
public class IupFileDialog : IupDialogBase
{
    ...
    */
    @property 
	{
		public bool allowNew() { return getAttribute(IupAttributes.AllowNew) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
		public bool canMultiSelect() { return getAttribute(IupAttributes.MultipleFiles) == FlagIdentifiers.Yes; }

		public void canMultiSelect(bool value) 
		{
            setAttribute(IupAttributes.MultipleFiles, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
		}
	}
    ...
    */
    @property 
	{
		public bool canShowHidden() { return getAttribute(IupAttributes.ShowHidden) == FlagIdentifiers.Yes; }
    ...
    */
    @property 
	{
		public FileDialogType dialogType() { return m_dialogType; }
    ...
    */
    @property 
	{
		public string defaultExt()  {  return getAttribute(IupAttributes.ExtDefault); }
        public void defaultExt(string value) { setAttribute(IupAttributes.ExtDefault, value);}
	}
    ...
    */
    @property 
	{
		public string extFilter()  {  return getAttribute(IupAttributes.ExtFilter); }
        public void extFilter(string value) { setAttribute(IupAttributes.ExtFilter, value);}
	}
    ...
    */
    @property 
	{
		public string initialDirectory()  {  return getAttribute(IupAttributes.Directory); }
        public void initialDirectory(string value) { setAttribute(IupAttributes.Directory, value);}
	}
    ...
    */
    @property 
	{
		public string initialFile()  { return getAttribute(IupAttributes.File); }
		public void initialFile(string value) { setAttribute(IupAttributes.File, value); }
	}
    ...
    */
    @property 
	{
		public bool isFileExisted() { return getAttribute(IupAttributes.FileExist) == FlagIdentifiers.Yes; }
	}

    @property 
	{
		public bool isPreviewAtRight() { return getAttribute(IupAttributes.PreviewAtRight) == FlagIdentifiers.Yes; }

		public void isPreviewAtRight(bool value) 
		{
            setAttribute(IupAttributes.PreviewAtRight, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
		}
	}
    ...
    */
    @property 
	{
		public string fileName()  { return getAttribute(IupAttributes.Value); }
		public void fileName(string value) { setAttribute(IupAttributes.Value, value); }
	}
    ...
    */
    @property 
	{
		public string filter()  { return getAttribute(IupAttributes.Filter); }
		public void filter(string value) { setAttribute(IupAttributes.Filter, value); }
	}
    ...
    */
    @property 
	{
		public string filterInfo()  { return getAttribute(IupAttributes.FilterInfo); }
		public void filterInfo(string value) { setAttribute(IupAttributes.FilterInfo, value); }
	}
    ...
    */
    @property 
	{
		public iup.IupGLCanvas gLCanvas()  { return m_gLCanvas; }
    ...
    */
    @property 
	{
		public bool restoreDirectory() { return getAttribute(IupAttributes.NoChangeDir) == FlagIdentifiers.No; }

		public void restoreDirectory(bool value) 
		{
            setAttribute(IupAttributes.NoChangeDir, value ? FlagIdentifiers.No : FlagIdentifiers.Yes);
		}
	}
    ...
    */
    @property 
	{
		public bool overwritePrompt() { return getAttribute(IupAttributes.NoOverwritePrompt) == FlagIdentifiers.No; }

		public void overwritePrompt(bool value) 
		{
            setAttribute(IupAttributes.NoOverwritePrompt, value ? FlagIdentifiers.No : FlagIdentifiers.Yes );
		}
	}
    ...
    */
    @property 
	{
		public int previewHeight()  {  return getIntAttribute(IupAttributes.PreviewHeight); }
        public void previewHeight(int value) { setIntAttribute(IupAttributes.PreviewHeight, value);}
	}
    ...
    */
    @property 
	{
		public int previewWidth()  {  return getIntAttribute(IupAttributes.PreviewWidth); }
        public void previewWidth(int value) { setIntAttribute(IupAttributes.PreviewWidth, value);}
	}

    @property 
	{
        public HDC deviceContext() { return cast(HDC)getPointerAttribute(IupAttributes.PreviewDc); }
	}
    ...
    */
    @property 
	{   
		public int selectionCount()  {  return getIntAttribute(IupAttributes.MultiValueCount); }
...
public class IupFontDialog : IupDialogBase
{
    ...
    else
    {
        ...
        */
        @property 
        {
            public string previewText()  {  return getAttribute(IupAttributes.PreviewText); }
            public void previewText(string value) { setAttribute(IupAttributes.PreviewText, value);}
        }
    }
...
public class IupLayoutDialog : IupDialog
{
    ...
    */
    @property 
	{
		public bool canDestroy() { return getAttribute(IupAttributes.DestroyWhenClosed) == FlagIdentifiers.Yes; }

		public void canDestroy(bool value) 
		{
            setAttribute(IupAttributes.DestroyWhenClosed, value ? FlagIdentifiers.Yes : FlagIdentifiers.No);
		}
	}
}
...
public class IupMessageDialog : IupDialogBase
{
    ...
    */
    @property 
	{
		public MessageBoxButtons buttons() { return m_buttons; }
    ...
    */
    @property 
	{
		public MessageDialogType dialogType() { return m_dialogType; }
    ...
    */
    @property 
	{
		...
		public void message(string value) { m_message = value; 
    ...
    */
    @property 
	{
		public DialogResult defaultResult() { return m_defaultResult; }
...
public class IupTextInputDialog
{
    ...
    DialogResult showDialog()
    {
        int r = iup.c.IupGetText(std.string.toStringz(m_title),
...
{ 
    ...
    */
    @property 
	{
        ...
        public void count(int value) { setIntAttribute(IupAttributes.Count, value);}
	}
    ...
    */
    @property 
	{
        string description() { return getAttribute(IupAttributes.Description); }
        void description(string value) { setStrAttribute(IupAttributes.Description, value); }
	}
    ...
    */
    @property 
	{
		public int percent()  {  return getIntAttribute(IupAttributes.Percent); }
        public void percent(int value) { setIntAttribute(IupAttributes.Percent, value);}
	}
    ...
    */
    @property 
	{
		public int totalCount()  {  return getIntAttribute(IupAttributes.TotalCount); }
        public void totalCount(int value) { setIntAttribute(IupAttributes.TotalCount, value);}
	}
    ...
    */
    public void increment(int value = 1) { setIntAttribute(IupAttributes.Inc, value);}
}
...
public class IupMessageBox
{
    ...
    It also uses a global attribute called "ICON" as the dialog icon if it is defined.
    */
    static int show(string title, string message, string button1, string button2 = null, string button3 = null)
    {
    ...
    static DialogResult show(string title, string message, MessageBoxButtons button)
	{
        ...
        {
            case MessageBoxButtons.OkCancel:
                selection = iup.c.IupAlarm(_title, _message, "Ok", "Cancel", null);
            ...
            case MessageBoxButtons.AbortRetryIgnore:
                selection = iup.c.IupAlarm(_title, _message, "Abort", "Retry", "Ignore");
                if(selection == 1)
            ...
            case MessageBoxButtons.YesNoCancel:
                selection = iup.c.IupAlarm(_title, _message, "Yes", "No", "Cancel"); 
            ...
            case MessageBoxButtons.YesNo:
                selection = iup.c.IupAlarm(_title, _message, "Yes", "No", null);
            ...
            case MessageBoxButtons.RetryCancel:
                selection = iup.c.IupAlarm(_title, _message, "Retry", "Cancel", null);
